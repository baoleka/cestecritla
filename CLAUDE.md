...
- Point d'entrée : `docs/discovery/00-resume-executif.md`, puis `docs/discovery/decisions.md` (**172 décisions, D0-D14** — mesure : `grep -cE '^\| D[0-9]+\.[0-9]+[a-z]? \|' docs/discovery/decisions.md`) et `docs/discovery/16-hypotheses.md`.
