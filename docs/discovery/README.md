...
| 3 | `decisions.md` | **172 décisions, D0-D14** (`grep -cE '^\| D[0-9]+\.[0-9]+[a-z]? \|' docs/discovery/decisions.md`). Source unique. **D13.1 à D13.8** et **D14.8 à D14.12** = les arbitrages de l'utilisateur du 10/9/2026 ; **D14.1 à D14.7** = les sept défauts du §19.3, appliqués et réversibles |
